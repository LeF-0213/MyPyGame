...
# 난이도
DIFFICULTY_LEVELS = {
  1: {"name": "EASY", "boss_hp": 100, "attack_speed": 3.0},
  2: {"name": "NORMAL", "boss_hp": 200, "attack_speed": 2.5},
  3: {"name": "HARD", "boss_hp": 300, "attack_speed": 2.0},
  4: {"name": "INSANE", "boss_hp": 500, "attack_speed": 1.5}
}
